# -*- coding: utf-8 -*-
#
# multitables documentation build configuration file, created by
...
# If true, `toodo` and `toodoList` produce output, else they produce nothing.
...
#
# html_title = u'multitables v1.0.0'
